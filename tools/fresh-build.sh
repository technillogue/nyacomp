...
# nyacomp-$VERSION-cp310-cp310-manylinux_2_17_x86_64.manylinux2014_x86_64.whl
WHEEL="nyacomp-$VERSION-cp310-cp310-linux_x86_64.whl"
...
patchelf --add-rpath '$ORIGIN/nyacomp.libs' _nyacomp.cpython-310-x86_64-linux-gnu.so
